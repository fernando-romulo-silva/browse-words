...
public class BrowseWordsUtils {
    ...
    public static final List<String> getUrlFromJson02(final String jsonString) {
        ...
        final DocumentContext context = JsonPath.using(c).parse(jsonString);

        final ArrayNode arrayNote = context.read("$..set[*]._webUrl");

        final var result = new ArrayList<String>();

        for (final JsonNode jsonNode : arrayNote) {
